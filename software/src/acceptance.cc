...
bool Chades_hbt_acceptance_nosmear::TwoParticleAcceptance([[maybe_unused]] Chades_hbt_part *parta,[[maybe_unused]] Chades_hbt_part *partb,
...
bool Chades_hbt_acceptance_smear::TwoParticleAcceptance([[maybe_unused]] Chades_hbt_part *parta,
[[maybe_unused]] Chades_hbt_part *partb,[[maybe_unused]] double qinv,[[maybe_unused]] double qout,[[maybe_unused]] double qlong,[[maybe_unused]] double qside,[[maybe_unused]] double deleta,double dely,double delphi,
double &efficiency){
//// === HADES acceptance === ////
	bool acc=true;
  efficiency=1.0;
...
bool Chades_hbt_acceptance_smear_maria::OneParticleAcceptance(int pid, Chades_hbt_part *part, double &efficiency){
//// === HADES acceptance === ////
  efficiency=0.0;
	FourVector Plab;
	Misc::Boost(ucm,part->psmear,Plab);
...
bool Chades_hbt_acceptance_smear_maria::TwoParticleAcceptance([[maybe_unused]]Chades_hbt_part *parta,
[[maybe_unused]]Chades_hbt_part *partb, [[maybe_unused]] double qinv,
...
void Chades_hbt_acceptance_smear_maria::Smear(Chades_hbt_part *part){
